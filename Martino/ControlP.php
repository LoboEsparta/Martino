    ...
    <div id="content-wraper" class="d-flex">
        <div id="sidebar-container" class="border-right">
            ...
            <div class="menu list-group-flush">
              ...
              <a href="ControlP.html" class="list-group-item list-group-item-action" id="linea"> <img src="Img/Control.png" height="20" id="none"><img src="Img/Control.png" height="26" id="grande"> <span id="Negro"><img src="Img/Control2.png" height="35"></span> <span>Control</span></a>
            </div>
...
if(isset($_POST['boton1'])){
    ...
    $q="SELECT COUNT(*) as contar from usuarios where password='$clave'";
   ...
   // echo "Datos incorrectos";
    echo '<p class="alert alert-success agileits" role="alert">Datos incorrectos!';
