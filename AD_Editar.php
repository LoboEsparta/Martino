...
$consultaActualizar ="UPDATE auxiliar SET Nombre='$titulo1', Apellido_P='$categoria1', Apellido_M='$categoria2', Telefono='$categoria3', Contraseña='$categoria4' WHERE Ide=$variable0";
