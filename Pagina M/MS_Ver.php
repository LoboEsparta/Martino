            ...
            <div class="col-md-5">
                <div class="card border-dark mb-3">
                    <div class="card-body">
                        ...
                        <form action="">
                      <input type="text" value="<?php echo "$variable6"; ?>">
                      <input type="text" value="<?php echo "$variable7"; ?>">
                      <input type="text" value="<?php echo "$variable8"; ?>">
                      <input type="text" value="<?php echo "$variable9"; ?>">
                        </form>
