                ...
                <div class="row">
                    ...
                    //Utilizamos un forreach para hacer la cantidad de cards que vamos a ocupar, y de misma forma mostrar el contenido de los pedidos
                        ...
                        <div class="card border-dark mb-3 ">
                            ...
                            <h5><a href="AD_Ver.html"><img src="Img/eye - copia.png" height="18" data-toggle="tooltip"
                                        data-placement="right" title="Ver"></a>
                                <a href="AD_Editar.html"><img src="Img/edit.png" height="18" data-toggle="tooltip"
                                        data-placement="right" title="Editar"></a>
                                <button data-toggle="modal" data-target="#eliminar"><img src="Img/trash.png" height="18"
                                        data-toggle="tooltip" data-placement="right" title="Eliminar"></button>
                            </h5>
                        ...
                        <a href="AD_Agregar.html"><button type="button" class="btn btn-success">Registrar</button></a>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card border-dark mb-3">
                            <h6>Mesero 1</h6>
                            <h5><a href="MS_Ver.html"><img src="Img/eye - copia.png" height="18" data-toggle="tooltip"
                                        data-placement="right" title="Ver"></a>
                                <a href="MS_Editar.html"><img src="Img/edit.png" height="18" data-toggle="tooltip"
                                        data-placement="right" title="Editar"></a>
                                <button data-toggle="modal" data-target="#eliminar"><img src="Img/trash.png" height="18"
                                        data-toggle="tooltip" data-placement="right" title="Eliminar"></button>
                            </h5>
                        ...
                        <div class="card border-dark mb-3">
                            <h6>(Nombre de Mesero en esta linea)</h6>
                            <h5><a href="MS_Ver.html"><img src="Img/eye - copia.png" height="18" data-toggle="tooltip"
                                        data-placement="right" title="Ver"></a>
                                <a href="MS_Editar.html"><img src="Img/edit.png" height="18" data-toggle="tooltip"
                                        data-placement="right" title="Editar"></a>
                        ...
                        <a href="MS_Agregar.html"><button type="button" class="btn btn-success">Registrar</button></a>
